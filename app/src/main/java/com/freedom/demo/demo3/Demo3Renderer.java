...
public class Demo3Renderer implements GLSurfaceView.Renderer {
...
//    private static final String A_POSITION = "a_Position";
    ...
    public Demo3Renderer(Context c) {
        mContext = c;
...
//        GLES20.glDisableVertexAttribArray(mTexCoordLoc);
        ...
        mUvBuffer1 = setupImage("mapa1.png");
        ...
        FloatBuffer uvBuffer20 = setupImage("mapb1.png");
        ...
        FloatBuffer uvBuffer1 = setupImage("mapa1.png");
        ...
        FloatBuffer uvBuffer2 = setupImage("mapa3.png");
        ...
        FloatBuffer uvBuffer3 = setupImage("mapa4.png");
        ...
        FloatBuffer uvBuffer4 = setupImage("mapa5.png");
        ...
        FloatBuffer uvBuffer5 = setupImage("mapa1.png");
        ...
        FloatBuffer uvBuffer6 = setupImage("mapa1.png");
        ...
        FloatBuffer uvBuffer7 = setupImage("mapa1.png");
        ...
        FloatBuffer uvBuffer8 = setupImage("mapa1.png");
        ...
        FloatBuffer uvBuffer9 = setupImage("mapa1.png");
        ...
        FloatBuffer uvBuffer10 = setupImage("mapa1.png");
        ...
        FloatBuffer uvBuffer11 = setupImage("mapa1.png");
        ...
        FloatBuffer uvBuffer12 = setupImage("mapb1.png");
        ...
        FloatBuffer uvBuffer13 = setupImage("mapb1.png");
        ...
        FloatBuffer uvBuffer14 = setupImage("mapb1.png");
    ...
    public FloatBuffer setupImage(String id) {
...
//        int id = mContext.getResources().getIdentifier("drawable/mapa1", null, mContext.getPackageName());

        // Temporary create a bitmap
        //通过options改变图片的参数


        Bitmap bmp = maps.get(id);
        if (bmp == null){
            try {
                bmp = BitmapFactory.decodeStream(mContext.getResources().getAssets().open(id));
                maps.put(id,bmp);
            } catch (IOException e) {
                e.printStackTrace();
            }
